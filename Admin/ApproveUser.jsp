<%-- 
    ...
    Created on : 24 Feb, 2018, 3:51:29 PM
    Author     : win7u
--%>
...
<html>
        <head>
            ...
            <title>Governmentbodies::approval</title>
        </head>
        <body bgcolor="pink">
...
<%
    String a="";
        ...
        {
          String upd="update tbl_user set user_status=1 where user_id='"+request.getParameter("eid")+"'";
         ...
         if(request.getParameter("did")!=null)
        {
             ...
             String SEL="SELECT * from tbl_user where user_id='" + request.getParameter("did") + "'";
