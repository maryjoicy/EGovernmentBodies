...
//boolean isMultipart=ServletFileUpload.isMultipartContent(request);
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("txtadhar")) {
                            // if(field_name.equals("photo"))
                            {
                                ...
                                String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Guest\\adhar\\";
                                Random r = new Random();
                         ...
                         if (field_name.equals("txtprev")) {
                            // if(field_name.equals("photo"))
                            {
                                ...
                                String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Guest\\previouswork\\";
                                Random r = new Random();
                                int r_num = r.nextInt(1111) + 999;
    ...
    //Strinh str1="insert into tbl_user ()";
                ...
                String insQry1 = "insert into tbl_contractor(contractor_name,contractor_address,district_id,place,phone,departmenttype_id,adharproof,previouswork,login_id,status)"
                        + " values ('" +value[0]+ "','" + value[3] + "','" + value[4]+ "','" +value[5]+ "','" +value[6]+ "','" +value[7]+ "','"+fn+"','"+pf+"','" +loginid + "',1)";
