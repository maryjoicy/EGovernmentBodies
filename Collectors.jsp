    ...
    <body>
        <%
            ...
            if (request.getParameter("btnsubmit") != null) {
                ...
                CollUserName =request.getParameter("txtuname");
                CollPwd =request.getParameter("txtcomppass");
                ...
                String insQry = "insert into tbl_login(login_username,login_password,login_usertype)values('" + CollUserName + "','" + CollPwd + "','collector')";
