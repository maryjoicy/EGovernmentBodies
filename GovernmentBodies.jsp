...
<html>
    ...
    <body>
        <%
             ...
             String LogID="";
             String GovernName="";
             String GovernUserName="";
             String GovernPassword="";
             ...
             if(request.getParameter("did")!=null)
            {
             ...
             if (request.getParameter("btnsubmit")!=null)
             {
                 ...
                 GovernUserName=request.getParameter("txtuname");
                 GovernPassword=request.getParameter("pwd");
                 ...
                 String insQry="insert into tbl_login(login_username,login_password,login_usertype)values('"+GovernUserName+"','"+GovernPassword+"','"+govtypename+"')";
                 out.println(insQry);
